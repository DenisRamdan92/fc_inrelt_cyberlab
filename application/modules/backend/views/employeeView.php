                        ...
                        <div class="row bg-white has-shadow">
                            ...
                            <div class="tab-content">
                                ...
                                <h3>Data</h3>
                                        ...
                                        <th style="display:none">No. Ktp</th>
                                        ...
                                        echo "<td>".$de['telp']."</td>";
                                        echo "<td>".$de['email']."</td>";
                                        echo "<td style='display:none'>".$de['nip']."</td>";
                                        echo "<td style='display:none'>".$de['no_ktp']."</td>";
                                        echo "<td style='display:none'>".$de['sex']."</td>";
                                        echo "<td style='display:none'>".$de['religion']."</td>";
                                        echo "<td style='display:none'>".$de['education']."</td>";
                                        echo "<td>".$status."</td>";
