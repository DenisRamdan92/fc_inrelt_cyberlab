	...
	<div class="modal-dialog modal-lg" role="document" style="width:100%">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title" id="title_pengguna"> Tambah blog</h5>
			</div>
			<div class="modal-body">
				<form id="frm" data-toggle="validator" role="form">
					<input type="hidden" name="id_blog" id="id_blog">
                    <div class="form-group">
						<label for="recipient-name" class="control-label mb-10">Judul Blog </label>
						<input type="text" class="form-control"  name="title_blog" id="title_blog" required="">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="control-label mb-10">Tag </label>
						<select class="form-control"  name="id_lesson" id="id_tag" required="">
							<option value="" ></option>
						</select>
					</div>
					<div class="form-group">
						<label for="recipient-name" class="control-label mb-10">Judul </label>
						<input type="text" class="form-control"  name="title_blog" id="title_blog" required="">
					</div>
                    <div class="form-group">
						<label for="recipient-name" class="control-label mb-10">Konten </label>
						<input type="text" class="form-control"  name="content_blog" id="content_blog" required="">
					</div>
				</form>
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var pengguna = $('#table_user').DataTable({ 
        	...
        	"ajax": {
            	"url": "<?php echo base_url()?>backend/blog/ajax_list",
            	"type": "POST"
        	},
