...
class EmployeeModel extends CI_Model{
    ...
    var $column_search = array("name_employee","place_of_birth","date_of_birth","address","telp","email","nip","no_ktp","sex","religion","education","status"); //set column field database for datatable searchable 
    var $order = array('id_employee' => 'desc'); // default order
	...
	private function _get_datatables_query()
    {
        ...
        $tbl_storage = $this->db->get("tbl_employee");
	...
	{
		$this->db->where("name_employee",$employee);
