...
class CommentModel extends CI_Model{
	...
	var $id_member = "";
	var $column_order = array(null, 'u.id_comment'); //set column field database for datatable orderable
    var $column_search = array('u.content_comment','e.title_blog','u.sender'); //set column field database for datatable searchable 
    var $order = array('u.id_comment' => 'desc'); // default order
    ...
    {
		$this->db->select("*");
        $this->db->join("tbl_blog e","e.id_blog=u.id_blog","left");
    ...
    {
		$this->db->join("tbl_comment g","g.id_blog=u.id_blog","left");
	...
	// {
	// 	$this->db->select("content_comment,id_comment,sender");
	// 	$this->db->like("content_comment",$x);
